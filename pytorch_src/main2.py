...
parser.add_argument('--nst_alpha', default=0, type=float)
...
def main():
    ...
    train_labeled_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/train_labeled_4366.csv', labeled=True, train=True)
    train_unlabeled_set = dataset('/nfs/masi/hansencb/nlst_nst_mixmatch/data_organization/train_unlabeled_4366.csv', labeled=False, train=True)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_loss_x, train_loss_u, train_loss_nst = train(labeled_trainloader, model, optimizer, ema_optimizer, train_criterion, epoch, use_cuda)
...
def train(labeled_trainloader, model, optimizer, ema_optimizer, criterion, epoch, use_cuda):
    ...
    for batch_idx in range(args.val_iteration):
        ...
        Lx = nn.BCEWithLogitsLoss()(output_x.view(-1), targets_x)
...
def validate(valloader, model, criterion, epoch, use_cuda, mode):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(valloader):
            ...
            prec1, prec5 = accuracy(outputs, targets, topk=(0,0))
